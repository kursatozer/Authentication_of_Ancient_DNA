...
TAXID= args[1] #1302
FOLDER<-args[2] #="itk095-b1e1l1p1_TAATGCG-TTACTTA_L002_ARmerged.210803_A00187_0543_BHCFVTDRXY.all.fastq.gz_PipelineOutput"
OUTFILE <- paste0(TAXID,"_",FOLDER, ".pdf")

cat(TAXID, FOLDER, OUTFILE, "\n")
...
ggsave(filename = OUTFILE, plot = last_plot, device = "pdf", width = 4*3, height = 3*3)
